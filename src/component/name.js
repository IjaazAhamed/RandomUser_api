...
const Name = () => {
  ...
  return (
    ...
    <button className='but' onClick={()=>getData()}>Refresh</button>
    <div>
        ...
        return (
            <div className='flex' key={key} >
                ...
                <ul className='my-list' >
                    <li><a>Image:. <img src={el.picture.large}></img></a></li><br/>
                    <li><a>Name:. {fullName}</a></li><br/>
                    <li><a>Email:. {el.email}</a></li><br/>
                    <li><a>Gender:. {el.gender}</a></li><br/>
                    <li><a>City:. {el.location.city}</a></li><br/>
                    <li><a>Country:. {el.location.country}</a></li><br/>
                    <li><a>Postcode:. {el.location.postcode}</a></li>
